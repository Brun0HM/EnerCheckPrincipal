...
import ResumoPedido from "../../components/Payments/ResumoPedido";
import MetodoPagamento from "../../components/Payments/MetodoPagamento";
import CreditCardForm from "../../components/Payments/CreditCardForm";
import Pix from "../../components/Payments/Pix";
import Boleto from "../../components/Payments/Boleto";
        ...
        <div className={`mainContent w-75`}>
          <div className="text-center d-flex flex-column align-items-center justify-content-center px-3">
            ...
            <div className="w-100 d-flex flex-column flex-lg-row gap-4 align-items-stretch px-2 px-lg-3">
              <div
                className="border border-2 border-opacity-10 shadow d-flex flex-column rounded-4 px-3 py-3 col-12 col-lg-7"
                style={{
              ...
              >
                <div className="d-flex justify-content-between align-items-center ">
                  <div>
                    <p className="m-0 fw-bold fs-5 text-start ms-3">
                      Informações de Pagamento
                    </p>
                    <p className="small text-start ms-3">
              ...
              <div
                className="col-12 col-lg-3 p-4 border border-3 rounded-4 shadow h-100"
                style={{
                  backgroundColor: "var(--card-bg)",
                  borderColor: "var(--card-border)",
                }}
