...
const DashboardProjeto1 = () => {
  const [isLoading, setIsLoading] = useState(false);

  // Dados pré-setados - Análise Elétrica NBR 5410
  const [dadosProjeto] = useState({
    nome: "Análise Elétrica NBR 5410",
    dataAnalise: "09/12/2025",
    observacaoGeral:
      "A planta está parcialmente conforme. A separação de circuitos e as bitolas mínimas para TUGs foram respeitadas. Contudo, há não conformidades críticas na quantificação de tomadas em áreas molhadas (Cozinha e Lavanderia) e ausência de informações vitais de segurança (DR, DPS e detalhe de disjuntores no Quadro de Cargas). O projeto necessita de complementação documental.",
    pontuacaoGeral: 40,
    categorias: [
      {
        ...
        naoConformidades: [
          ...
          "Dimensionamento de TUEs: O TUE da Cozinha (2500 VA / 4 mm²) precisa ter o disjuntor e a ampacidade verificados.",
          "Taxa de Ocupação: O diâmetro dos eletrodutos (25 mm) precisa ser verificado quanto à taxa de ocupação dos condutores.",
        ],
      },
      {
        ...
        naoConformidades: [
          ...
          "Altura das Tomadas: A altura de instalação (baixa, média, alta) não está especificada.",
        ],
      },
      {
        ...
        naoConformidades: [
          ...
          "Não Conformidade Crítica - Dispositivos DR: Não há indicação de Dispositivos DR (Diferencial Residual), obrigatórios para áreas molhadas (Banheiro, Cozinha, Lavanderia) e para o chuveiro.",
          "Continuidade do Terra: É crucial confirmar que o condutor de proteção (terra) está presente e conectado a todos os pontos de utilização (tomadas e TUEs).",
          "Dispositivos DPS: Ausente a indicação de Dispositivos de Proteção contra Surtos (DPS).",
        ],
      },
      {
        ...
        naoConformidades: [
          ...
          "Detalhes de Instalação: Ausentes notas ou detalhes importantes (ex: tipo de aterramento, caixas de passagem).",
        ],
      },
    ],
  });
...
export default DashboardProjeto1;
